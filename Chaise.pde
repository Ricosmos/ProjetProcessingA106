...
PShape createAssiseChaise() {
  ...
  PShape assiseChaise = createCubeMagique(textures, defaultColors);
...
PShape createDossierChaise() {
  ...
  PShape dossierChaise = createCubeMagique(textures, defaultColors, true);
...
PShape createPiedChaise() {
  ...
  PShape piedChaise = createCubeMagique(textures, defaultColors);
